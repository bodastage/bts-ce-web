            ...
            <GridLayout className="layout" 
              ...
              <div key="a" className="rgl-border">
                  <div className="card">
                    ...
                    <div style={{heigth: this.state.mapHeight+"px", overflowY: "scroll"}}>
                        <SiteStatsMap data={this.props.data} panelHeight={this.state.mapHeight} range_colors={this.color_palete}/>
                    </div>
                  </div>
              ...
              <div key="b" className="rgl-border">
                ...
                <div style={{height: this.state.keyHeight-30, overflowY: "scroll"}}>
                    <SiteStatsKeys range_colors={this.color_palete}/>
                </div>
              ...
              <div key="c" className="rgl-border">
                  <div className="card">
                    ...
                    <div style={{ overflowY: "scroll"}}>
                        <SiteStatsTable data={this.props.data} panelHeight={this.state.dataHeight} range_colors={this.color_palete}/>
                    </div>
                  </div>    
              </div>
